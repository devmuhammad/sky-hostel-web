          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Each email address can only be used for one payment. If you have already made a payment with this email, please use a different email address or contact support for assistance.
              </p>
            </div>
          </div>
        </div>
