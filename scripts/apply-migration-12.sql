-- Migration 12: Digital Resumption Checklist / Gate Verification
-- Incremental — no drops of existing data.
...
-- Backfill pending verifications for existing students for 2026/2027
...
SELECT 'Migration 12 (resumption checklist) applied successfully' AS status;
