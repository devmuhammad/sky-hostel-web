...
// Resumption Check-in icon
const ResumptionIcon = (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ADMIN_NAVIGATION: NavigationItem[] = [
  ...
  {
    name: "Resumption Check-in",
    href: "/admin/resumption-checkin",
    icon: ResumptionIcon,
    roles: ["admin", "super_admin", "porter", "other", "hostel_manager", "front_desk"],
  },
  {
    name: "Payments",
    href: "/admin/payments",
